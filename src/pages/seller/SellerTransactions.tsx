...
export default function SellerTransactions() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="font-serif text-3xl text-primary">My Deals</h1>
        <p className="text-muted-foreground mt-1">Transactions on your listed properties.</p>
      </div>
        ...
        <Table>
          ...
          <TableBody>
            {isLoading ? (
              ...
              filtered.map(tx => {
                const sellerReceives = (tx.agreed_price ?? 0) * 0.9
                return (
